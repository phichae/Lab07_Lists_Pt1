...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(A_removeAtIndex0_emptyList, "A_removeAtIndex0_emptyList");
			// Scenario: 44
		testEmptyList(A_iteratorNextRemove_emptyList, "A_iteratorNextRemove_emptyList");
		...
		//3-element to empty list
			// Scenario: 54
		testEmptyList(ABC_iteratorNextRemoveNextRemoveNextRemove_emptyList, "ABC_iteratorNextRemoveNextRemoveNextRemove_emptyList");
			
		//3-element to 1-element
			// Scenario: 51
		testSingleElementList(ABC_iteratorNextRemoveNextRemove_C, "ABC_iteratorNextRemoveNextRemove_C", LIST_C, STRING_C);
			// Scenario: 52
		testSingleElementList(ABC_iteratorNextRemoveNextNextRemove_B, "ABC_iteratorNextRemoveNextNextRemove_B", LIST_B, STRING_B);

			// Scenario: 53
		testSingleElementList(ABC_iteratorNextNextRemoveNextRemove_A, "ABC_iteratorNextNextRemoveNextRemove_A", LIST_A, STRING_A);
		...
		if (SUPPORTS_LIST_ITERATOR) {
			...
			//Scenario: 57
			testSingleElementList(AB_listIteratorNextRemove_A, "AB_listIteratorNextRemove_A", LIST_A, STRING_A);
			// Scenario: 60
			testTwoElementList(ABC_listIteratorNextRemove_AC, "ABC_listIteratorNextRemove_AC", LIST_AC, STRING_AC);
			...
			testTwoElementList(ABC_listIterator2PreviousRemove_AC, "ABC_listIterator2PreviousRemove_AC", LIST_AC, STRING_AC);
      		...
      		// Scenario:87
			testThreeElementList(AB_listIterator0NextAdd_ACB, "AB_listIterator0NextAdd_ACB", LIST_ACB, STRING_ACB);

			//Scenario: 90
			testThreeElementList(AB_listIterator2PreviousAdd_ACB, "AB_listIterator2PreviousAdd_ACB", LIST_ACB, STRING_ACB);
      
     		 //Scenario: 96
			testThreeElementList(ABC_listIterator1NextSetD_ADC, "ABC_iteratorNextSetD_ADC", LIST_ADC, STRING_ADC);

			//Scenario: 99
			testThreeElementList(ABC_listIterator2PreviousSetD_ADC, "ABC_listIterator2PreviousSetD_ADC", LIST_ADC, STRING_ADC);
	...
	private Scenario<Integer> ABC_iteratorNextRemove_BC = () -> ABC_iteratorNextRemove_BC();
	...
	private Scenario<Integer> ABC_iteratorNextNextNextRemove_AB = () -> ABC_iteratorNextNextNextRemove_AB();
	...
	private Scenario<Integer> ABC_iteratorNextRemoveNextRemove_C = () -> ABC_iteratorNextRemoveNextRemove_C();
	...
	private Scenario<Integer> ABC_iteratorNextRemoveNextNextRemove_B = () -> ABC_iteratorNextRemoveNextNextRemove_B();
	...
	private Scenario<Integer> ABC_iteratorNextNextRemoveNextRemove_A = () -> ABC_iteratorNextNextRemoveNextRemove_A();
	...
	//Scenario:87 [A,B] -> list-iterator(0),next(),add() -> [A,C,B]
	private IndexedUnsortedList<Integer> AB_listIterator0NextAdd_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
	...
	private Scenario<Integer> AB_listIterator0NextAdd_ACB = () -> AB_listIterator0NextAdd_ACB();
	...
	// Scenario #57
	private IndexedUnsortedList<Integer> AB_listIteratorNextRemove_A() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> iterator = list.listIterator(1);
		iterator.next();
		iterator.remove();
	...
	private Scenario<Integer> AB_listIteratorNextRemove_A = () -> AB_listIteratorNextRemove_A();

	// Scenario #60
	private IndexedUnsortedList<Integer> ABC_listIteratorNextRemove_AC() {
		IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
		ListIterator<Integer> iterator = list.listIterator(1);
		iterator.next();
		iterator.remove();
	...
	private Scenario<Integer> ABC_listIteratorNextRemove_AC = () -> ABC_listIteratorNextRemove_AC();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			//TODO: @watermelon2718 uncomment
			// // Iterator
			// 	// TODO: pasted from single element list 
			// 	// test to construct iterator
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			// 	// tests after getting iterator	
			printTest(scenarioName + "_testIterHasNext", testIterHasNext(WrapIt.prep(scenario.build()).getIterator(), Result.True));
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				//TODO: Review "contents" and "scenario.build, 1" not sure what that means lol
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			//tests after calling next next next on iterator
			...
			// 	// tests after calling next on an iterator
			// printTest(scenarioName + "_iterNext_testIterHasNext", testIterHasNext(WrapIt.prep(scenario.build()).next().getIterator(), Result.True));
			// printTest(scenarioName + "_iterNext_testIterNext", testIterNext(WrapIt.prep(scenario.build()).next().getIterator(), ELEMENT_B, Result.MatchingValue));
			// printTest(scenarioName + "_iterNext_testIterRemove", testIterRemove(WrapIt.prep(scenario.build()).next().getIterator(), Result.NoException));

			// 	//tests after calling next and then next on an iterator
			// printTest(scenarioName + "_iterNextNext_testIterHasNext", testIterHasNext(WrapIt.prep(scenario.build()).next().next().getIterator(), Result.True));
			// printTest(scenarioName + "_iterNextNext_testIterNext", testIterNext(WrapIt.prep(scenario.build()).next().next().getIterator(), ELEMENT_C, Result.MatchingValue));
			// printTest(scenarioName + "_iterNextNext_testIterRemove", testIterRemove(WrapIt.prep(scenario.build()).next().next().getIterator(), Result.NoException));


			// 	// tests after calling next and then next and then next on an iterator
			// 	printTest(scenarioName + "_iterNextNextNext_testIterHasNext", testIterHasNext(WrapIt.prep(scenario.build()).next().next().next().getIterator(), Result.False));
			// 	printTest(scenarioName + "_iterNextNextNext_testIterNext", testIterNext(WrapIt.prep(scenario.build()).next().next().next().next().getIterator(), ELEMENT_X, Result.NoSuchElement));
			// 	printTest(scenarioName + "_iterNextNextNext_testIterRemove", testIterRemove(WrapIt.prep(scenario.build()).next().next().next().getIterator(), Result.NoException));
