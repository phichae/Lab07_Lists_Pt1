...
public class ListTester {
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iterNextNextNext_testIterHasNext", testIterHasNext(WrapIt.prep(scenario.build()).next().next().getIterator(), Result.False));
			printTest(scenarioName + "_iterNextNextNext_testIterRemove", testIterRemove(WrapIt.prep(scenario.build()).next().next().getIterator(),  Result.NoException));
